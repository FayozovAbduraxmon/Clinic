                                ...
                                <form action="/save_user" method="POST">
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="text" id="form3Example4cg" class="form-control form-control-lg"
                                            name="text" />
                                        <label class="form-label" for="form3Example4cg">Text</label>
                                    </div>


                                    
                                    <div class="form-outline mb-4">
                                        <input type="phone" id="form3Example4cg" class="form-control form-control-lg"
                                            name="phone" />
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="address" id="form3Example4cg" class="form-control form-control-lg"
                                            name="address" />
